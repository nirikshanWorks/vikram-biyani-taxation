      ...
      <div className="container-page grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -bottom-6 -right-4 bg-navy text-navy-foreground rounded-2xl p-5 shadow-elevated max-w-[220px]">
            ...
            <div className="text-xs uppercase tracking-wider opacity-90">Years teaching CA & CMA students</div>
          </div>
        </div>
        <div className="lg:col-span-7">
          <div className="text-xs uppercase tracking-[0.2em] text-gold font-semibold">About</div>
          <h2 className="mt-3 font-display text-3xl md:text-5xl font-bold text-navy">Meet CA Vikram Biyani</h2>
          <div className="mt-6 space-y-4 text-foreground/80 leading-relaxed">
            ...
            <p>
              His teaching philosophy focuses on simplifying complex tax provisions through real-world
              examples, visual learning techniques, and structured study plans that maximize exam performance.
            </p>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 gap-3">
            {features.map(f => (
              <div key={f.label} className="flex items-center gap-3 rounded-xl border border-border bg-card p-3.5">
