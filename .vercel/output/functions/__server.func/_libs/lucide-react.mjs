...
const BadgeQuestionMark = createLucideIcon("badge-question-mark", __iconNode$H);
const __iconNode$G = [
...
const Facebook = createLucideIcon("facebook", __iconNode$x);
const __iconNode$w = [
  [
    "path",
    {
...
const Infinity = createLucideIcon("infinity", __iconNode$s);
const __iconNode$r = [
  [
    "path",
    {
