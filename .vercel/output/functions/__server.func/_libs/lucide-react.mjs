...
const BadgeCheck = createLucideIcon("badge-check", __iconNode$U);
const __iconNode$T = [
  [
    "path",
    {
...
const BadgeQuestionMark = createLucideIcon("badge-question-mark", __iconNode$T);
const __iconNode$S = [
...
const Newspaper = createLucideIcon("newspaper", __iconNode$o);
const __iconNode$n = [
