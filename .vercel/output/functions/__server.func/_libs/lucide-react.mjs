...
const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$t);
const __iconNode$s = [
  [
    "path",
    {
...
const Headphones = createLucideIcon("headphones", __iconNode$q);
const __iconNode$p = [
...
const RefreshCcw = createLucideIcon("refresh-ccw", __iconNode$c);
const __iconNode$b = [
